...
public class CenozoCraftEntities {
    ...
    public static final EntityType<ThylacineEntity> THYLACINE = create("thylacine", ThylacineEntity::new, 1, 0.5f, 0x5c503f, 0x877754);
    public static final EntityType<TitanisEntity> TITANIS = create("titanis", TitanisEntity::new, 1, 0.5f, 0x5c503f, 0x877754);
